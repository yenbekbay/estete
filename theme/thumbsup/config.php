...
return array(
	 ...
	 */
	'url' => 'http://estete.net/wp-content/themes/estete/thumbsup/',
	 ...
	 */
	'database_dsn' => 'mysql:dbname=estete;host=localhost',

	/**
	 * (string) The username for the DSN string.
	 */
	'database_user' => 'yenbekbay',

	/**
	 * (string) The password for the DSN string.
	 */
	'database_pass' => 'QstYaBjH',
